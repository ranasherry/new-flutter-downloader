                ...
                children: [
                  ...
                  controller.isBrowsing.value
                      ...
                      : _textInput(controller.searchTextCTL,
                          "Past your URL here", TextInputType.text, false),
    ...
    return Padding(
      ...
      child: GridView(
        ...
        children: [
          ...
          _selectApp("Likee", AppImages.likee_ic, 3, 0xFF000000),
          _selectApp("Instagram", AppImages.instagram_ic, 4, 0xFFE90214),
          // _selectApp("Twitter", AppImages.twitter_ic, 5),
          _selectApp("Tiktok", AppImages.tiktok_ic, 6, 0xFF000000),
